...
const BelowTheFold = ({ workshop: workshopHandler, register: registerHandler, isLoading }) => {
  return (
    <>
      <About />
      <section className={`section bg-white is-fullheight ${coreCSS["section"]}`} id="guestLecture">
        <div className="container">
          <div className={`${coreCSS["section-title-wrapper"]} has-text-centered`}>
            <h2 className={coreCSS["section-title-landing"]}>Guest Lecture</h2>
            <h4>
          ...
          <div className={coreCSS["content-wrapper"]}>
            <div className={`columns is-vcentered ${coreCSS["pb-40"]} ${coreCSS["pt-40"]}`}>
              ...
              <div className="column is-6 is-offset-1">
                ...
                <div
                  className={`${coreCSS["title-divider"]} ${coreCSS["is-small"]} title-divider is-small`}
                ></div>
