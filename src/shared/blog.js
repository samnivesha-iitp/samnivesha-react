      ...
      <section className="container" style={{paddingTop:'40px'}}>
        <div className="intro column is-10 is-offset-1">
          ...
          <p className="subtitle">
            ...
            resistibility, BluePrint to showcase your designing skills, CiviQ to
            test your knowledge in this field, House of cards attracted huge
            participation from various colleges of Bihar. A workshop on STAAD
            PRO, software widely used in structural engineering was also
